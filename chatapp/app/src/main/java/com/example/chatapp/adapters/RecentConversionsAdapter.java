...
public class RecentConversionsAdapter extends RecyclerView.Adapter<RecentConversionsAdapter.ConversionViewHolder> {
    ...
    class ConversionViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage) {
            binding.textName.setText(chatMessage.conversionName.toUpperCase(Locale.ROOT));
            binding.textrecent.setText(chatMessage.message);
            binding.roundImage.setImageBitmap(getConversionImage(chatMessage.conversionImage));
